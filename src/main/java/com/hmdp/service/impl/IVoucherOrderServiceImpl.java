...
public class IVoucherOrderServiceImpl extends ServiceImpl<VoucherOrderMapper, VoucherOrder> implements IVoucherOrderService {
    ...
    private class VoucherOrderHandler implements Runnable {
        ...
        public void run() {
            while (true) {
                try {
                    // 1. 獲取消息隊列中的訂單資訊 XREADGROUP GROUP g1 c1 COUNT 1 BLOCK 2000 STREAMS streams.order >
                    ...
                    // 4. ACK 確認 SACK stream.orders g1 id
        ...
        private void handlePendingList() {
            while (true) {
                try {
                    // 1. 獲取 pending-list 中的訂單資訊 XREADGROUP GROUP g1 c1 COUNT 1 STREAMS streams.order 0
                    List<MapRecord<String, Object, Object>> list = stringRedisTemplate.opsForStream().read(
                            Consumer.from("g1", "c1"),
